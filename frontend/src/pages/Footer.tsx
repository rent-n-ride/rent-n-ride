...
const Footer: Component = () => {
  return (
    <div class="pb-7">
      ...
      <img
        src={benz}
        class="relative -mt-[40rem] h-[650px] flex mx-auto opacity-20 w-full"
      />

      <Line />
      <div class="w-11/12 flex mx-auto justify-between">
        <div class="flex gap-20">
          <h1 class="font-suntage text-3xl flex items-center">Contact</h1>
      ...
      <div class="w-11/12 mx-auto flex justify-between">
        <p class="font-montserrat">©Copyright 2023</p>

        <div class="flex gap-5">
          <p class="font-montserrat opacity-30">Privacy Policy</p>
          <hr class="w-[2px] h-[20px] rounded-full bg-yellow-300 flex my-auto opacity-20" />
          <p class="font-montserrat opacity-30">Terms of Condition</p>
        </div>
